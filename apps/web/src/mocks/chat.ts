...
export const mockMessages: Record<string, ChatMessage[]> = {
  '1': [
    ...
    },
    {
      ...
      citations: [{ id: 'c1', documentName: 'DeLonghi Coffee Maker Manual', page: 14 }],
  ...
  '2': [
    ...
    },
    {
      ...
      citations: [{ id: 'c2', documentName: 'Samsung 65" TV Manual', page: 32 }],
  ...
  '3': [
    ...
    },
    {
      ...
      citations: [{ id: 'c3', documentName: 'Land Title Certificate', page: 2 }],
